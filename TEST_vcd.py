...
#### fällt weg, so kann man ne exception abfangen und eine exception auf den browser/server zurückschicken, statt auf der maschine auf der der browser läuft
        try:
...
## ergebnisse cocepts liste als dictionary, jede zeil in der html-tabelle ist ein element (als dict) in der list
            concepts.extend([
                {
                    'annotationid': aid,
...
##
        ...
        s.wfile.write(response.encode())
## hpi.py zeile 83, zeile 165, zeile 236, für serverzugriff
