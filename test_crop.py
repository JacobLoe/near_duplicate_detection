...
im9 = np.asarray(Image.open('test_images/1999170.jpg'))[95:125, 165:349, :]
images_optimal_crop = [im0, im1, im2, im3, im4, im5, im6, im7, im8, im9]

images = [Image.open('test_images/171940.jpg'), Image.open('test_images/612240.jpg'), Image.open('test_images/630360.jpg'),
          ...
          Image.open('test_images/1999170.jpg')]
cc = {}
for t in [10, 12, 15, 25]: #5,7,10,12,15,17,
    ...
    for i, image in enumerate(images):
        ...
        b = [np.shape(a)[j]-x for j, x in enumerate(np.shape(images_optimal_crop[i]))]
        c.append(b)
        # print('residuals', b)
        # print('\n')
    cc[str(t)] = c
