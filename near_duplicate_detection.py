...
#    vgg16_model = VGG16(weights='imagenet', include_top=False,pooling='max') #pooling applies global max pooling to last layer #580
#    vgg19_model = VGG19(weights='imagenet', include_top=False,pooling='max')                                                   #876
#    ResNet50_model = ResNet50(weights='imagenet', include_top=False,pooling='max')                                             #226
#    InceptionV3_model = InceptionV3(weights='imagenet', include_top=False,pooling='max')                                       #14353
#    InceptionResNetV2_model = InceptionResNetV2(weights='imagenet', include_top=False,pooling='max')                           #35538
#    DenseNet121_model = DenseNet121(weights='imagenet', include_top=False,pooling='max')                                       #71
#    DenseNet169_model = DenseNet169(weights='imagenet', include_top=False,pooling='max')                                       #98
#    DenseNet201_model = DenseNet201(weights='imagenet', include_top=False,pooling='max')                                       #91
